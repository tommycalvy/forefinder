...
class b_plus_tree_map {
  ...
  private:
    ...
    class bpt_node_data : public bpt_node_base {
        ...
        constexpr static size_t M_leaf = std::min(size_t(16), size_t(COUNT_MAX));
        ...
        constexpr static size_t M_inner = std::min(size_t(16), size_t(COUNT_MAX) / M_leaf * 2);
        ...
        constexpr static size_t M_leaf_init = std::min(size_t(8), size_t(COUNT_MAX));
